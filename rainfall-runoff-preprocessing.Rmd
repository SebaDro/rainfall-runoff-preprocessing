...
that contains land cover information. We also have to be sure that he raster
dataset and the subbasin features have the same CRS.
...
res <- calculate_land_cover_frequency(subbasin, land_cover, id_col="id", join=TRUE)
